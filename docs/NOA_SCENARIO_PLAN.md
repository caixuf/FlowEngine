...
| 2.2 monitor 透传完整 entities | `modules/adas_nodes/monitor_node.c` | 🔴 待其他团队 |
| 2.3 3D 前端消费 entities | `tools/flowboard/js/scene3d.js` | ✅ 池扩展到 24 + NPC AI 状态标签 (PR #61) |
| 2.4 验证回归 | `demo_evaluator.py` | 🔴 待 Phase 1 完成 |
...
| 步骤 | 文件 | 状态 |
|------|------|------|
| 5.1 glTF 车辆模型 | `tools/flowboard/gen_models.py`, `models.js` | ✅ 轿车/卡车/SUV/行人 PBR 模型 + 异步加载 + 程序化降级 |
